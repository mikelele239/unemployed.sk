...
// App State Context (Mock Backend)
...
export const AppStateProvider = ({ children }) => {
  ...
  const [listings, setListings] = useState(() => {
    const saved = localStorage.getItem('employer_listings');
    return saved ? JSON.parse(saved) : [];
  });
  ...
  useEffect(() => { localStorage.setItem('employer_listings', JSON.stringify(listings)); }, [listings]);
